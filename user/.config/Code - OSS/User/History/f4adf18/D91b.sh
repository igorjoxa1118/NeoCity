...
read -p "ID Раздела USB(sda1), куда нужно сделать бэкап. Пр. /run/media/user/[acf95a0b-10df-4b51-96ff-5355b6bb35a8]: " dwm

UUID_store_drive="$(blkid -s UUID -o value /dev/sda1)"
