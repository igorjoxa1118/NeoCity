...
UUID_sda1="$(blkid -s UUID -o value /dev/sda1)"
UUID_sda1="$(blkid -s UUID -o value /dev/sda2)"
UUID_sda1="$(blkid -s UUID -o value /dev/sda3)"
UUID_sda1="$(blkid -s UUID -o value /dev/sda4)"

backup_drive=/run/media/"$username"/"$dwm"
