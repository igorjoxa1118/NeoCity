...
exec > >(tee /var/log/virOS.log) 2>&1
...
curl -s -Lo /usr/bin/pacstrap.sh https://raw.githubusercontent.com/igorjoxa1118/packstraps/main/pacstrap_bak
...
curl -s -o ${chroot_path}/usr/local/bin/settings.sh -L https://raw.githubusercontent.com/igorjoxa1118/packstraps/main/settings.sh
chmod +x ${chroot_path}/usr/local/bin/settings.sh

curl -s -o ${chroot_path}/usr/local/bin/strap.sh -L https://raw.githubusercontent.com/igorjoxa1118/packstraps/main/strap.sh
chmod +x ${chroot_path}/usr/local/bin/strap.sh

curl -s -o /usr/local/bin/system.sh -L https://raw.githubusercontent.com/igorjoxa1118/packstraps/main/system.sh
chmod +x /usr/local/bin/system.sh

curl -s -o ${chroot_path}/usr/local/bin/postinstall.sh -L https://raw.githubusercontent.com/igorjoxa1118/packstraps/main/postinstall.sh
