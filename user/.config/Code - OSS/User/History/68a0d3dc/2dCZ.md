...
```python
sudo pacman -S dialog yad cmus rsync mpv \
jq socat kitty lsd ranger micro blueman \
thunar polybar rofi dunst nitrogen picom \
yt-dlp fzf mcfly neofetch zsh starship \
