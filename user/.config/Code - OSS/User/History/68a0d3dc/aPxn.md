...
Если у вас появятся какие-то проблемы в процессе установки, то я вас предупрежу - $${\color{red}!! Пожалуйста, сделайте бэкап. !!}$$

$${\color{blue}Если у вас чистая система, тогда скрипт нужно запускать два раза. 
