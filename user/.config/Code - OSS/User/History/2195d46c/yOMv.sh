...
echo "UUID="$UUID_store_drive" $store_drive ext4 defaults 0 2" | sudo tee -a /home/vir0id/Загрузки/Скрипты/test
echo "UUID="$UUID_backup_drive" $backup_drive ext4 defaults 0 2" | sudo tee -a /home/vir0id/Загрузки/Скрипты/test