...
for folder in i3 alacritty picom rofi eww sxhkd dunst polybar ncmpcpp nvim ranger zsh mpd paru; do
...
[ -f ~/.zshrc ] && mv ~/.zshrc ~/.Backup_files/.zshrc-backup-"$(date +%Y.%m.%d-%H.%M.%S)"
