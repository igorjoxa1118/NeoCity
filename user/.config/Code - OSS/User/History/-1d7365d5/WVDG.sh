...
set_bspwm_config() {
	...
	bspc config active_border_color "#6D8895"
...
set_dunst_config() {
	sed -i "$HOME"/.config/bspwm/dunstrc \
		...
		-e "s/separator_color = .*/separator_color = \"#6D8895\"/g" \
...
set_jgmenu_colors() {
	sed -i "$HOME"/.config/bspwm/jgmenurc \
		...
		-e 's/color_norm_fg = .*/color_norm_fg = #6D8895/' \
		-e 's/color_sel_bg = .*/color_sel_bg = #222330/' \
		-e 's/color_sel_fg = .*/color_sel_fg = #6D8895/' \
