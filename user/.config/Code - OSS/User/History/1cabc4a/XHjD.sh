...
WIDTH_FIX_MAIN=1
WIDTH_FIX_STATUS=10
DIR="$HOME/.config/i3/rofi/rofi-network-manager"
...
function initialization() {
	source "$DIR/rofi-network-manager.conf" || source "${XDG_CONFIG_HOME:-$HOME/.config}/i3/rofi/rofi-network-manager/rofi-network-manager.conf"
	{ [[ -f "$DIR/rofi-network-manager.rasi" ]] && RASI_DIR="$DIR/rofi-network-manager.rasi"; } || { [[ -f "${XDG_CONFIG_HOME:-$HOME/.config}/i3/rofi/rofi-network-manager/rofi-network-manager.rasi" ]] && RASI_DIR="${XDG_CONFIG_HOME:-$HOME/.config}/i3/rofi/rofi-network-manager/rofi-network-manager.rasi"; } || exit
