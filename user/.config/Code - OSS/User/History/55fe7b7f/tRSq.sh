...
set_icons() {
    sed -i "s/gtk-icon-theme-name=.*/gtk-icon-theme-name="\"kora-green"\"/g" "$HOME"/.gtkrc-2.0
    sed -i "s/gtk-icon-theme-name=.*/gtk-icon-theme-name=kora-green/g" "$HOME"/.config/gtk-3.0/settings.ini
    sed -i "s/gtk-icon-theme-name=.*/gtk-icon-theme-name=kora-green/g" "$HOME"/.config/gtk-4.0/settings.ini	
}
