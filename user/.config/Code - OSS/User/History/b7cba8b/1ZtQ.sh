...
endoff=$(yad \
   ...
   --height=100 \
   --button-align=center \
   --button="!$HOME/.config/i3/scripts/polybar-mpv/icons/youtube.svg!Exit:bash -c close_exit_sec" \
   --button="!$HOME/.config/i3/scripts/polybar-mpv/icons/youtube.svg!Close:bash -c close" \
   --button="!$HOME/.config/i3/scripts/polybar-mpv/icons/youtube.svg!Audio:bash -c mpv_audio" \
   --button="!$HOME/.config/i3/scripts/polybar-mpv/icons/youtube.svg!Video:bash -c mpv_video" \
   --separator="\t")
