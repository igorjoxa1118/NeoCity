...
class HOPS_OT_Timer(bpy.types.Operator):
    ...
    timer_position_x: bpy.props.IntProperty(name="X Position", default=50, min=0, max=100, update=timer_position_x_upd)
    timer_position_y: bpy.props.IntProperty(name="Y Position", default=85, min=0, max=100, update=timer_position_y_upd)
