...
/**
 * Rofi Theme File (Catppuccin Mocha Edition)
...
* {
    /* Spacing and layout (original values) */
    ...
    /* Fonts (original values) */
    prompt-font:                 "MesloLGS NF Regular Bold 32";
    textbox-font:                "MesloLGS NF Regular 10";
    element-text-font:           "feather Bold 48";

    /* Catppuccin Mocha Color Palette */
    base:       rgba(30, 30, 46, 0.9);    /* #1e1e2e with 90% opacity */
    mantle:     rgba(24, 24, 37, 0.9);    /* #181825 */
    crust:      rgba(17, 17, 27, 0.9);    /* #11111b */
    ...
    background-normal:           var(base);
    background-selected:         var(mauve);
    foreground-normal:           var(text);
    foreground-selected:         var(base);
}
