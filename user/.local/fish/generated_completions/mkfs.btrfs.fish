...
complete -c 'mkfs.btrfs' -l device-uuid -d 'Create the filesystem with the given device-uuid UUID (also known as UUID_SUB…'
...
complete -c 'mkfs.btrfs' -s R -l runtime-features -d 'Removed in 6. 3, was used to specify features not affecting on-disk format'
