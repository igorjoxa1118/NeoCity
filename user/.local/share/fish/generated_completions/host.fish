...
complete -c host -s C -d 'This option indicates that \\X\'tty: link #std-iscman-named\'\\%named\\X\'tty: link…'
complete -c host -s d -d 'This option prints debugging traces, and is equivalent to the \\%-v verbose op…'
complete -c host -s l -d 'This option tells \\X\'tty: link #std-iscman-named\'\\%named\\X\'tty: link\' to list…'
...
complete -c host -s s -d 'This option tells \\X\'tty: link #std-iscman-named\'\\%named\\X\'tty: link\' not to …'
...
complete -c host -s W -d 'This options sets the length of the wait timeout, indicating that \\X\'tty: lin…'
