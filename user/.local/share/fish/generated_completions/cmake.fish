...
complete -c cmake -o LR -d 'Added in version 3. 31.  Show specific non-advanced cached variables'
...
complete -c cmake -l print-config-dir -d 'Added in version 3. 31'
complete -c cmake -l log-level -d 'Added in version 3. 16.  Set the log <level>'
...
complete -c cmake -l preset -l preset -d 'Reads a %preset from CMakePresets. json and CMakeUserPresets'
