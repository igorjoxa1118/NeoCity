...
complete -c node -l experimental-sqlite -d 'Enable the experimental node:sqlite module'
...
complete -c node -l experimental-test-snapshots -d 'Enable snapshot testing in the test runner'
