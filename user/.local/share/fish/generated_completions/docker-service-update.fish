...
complete -c docker-service-update -l health-start-interval -d '	Time between running the check during the start period (ms|s|m|h)'
...
complete -c docker-service-update -l oom-score-adj -d '	Tune host\'s OOM preferences (-1000 to 1000)'
