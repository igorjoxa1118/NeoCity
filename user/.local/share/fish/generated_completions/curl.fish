...
complete -c curl -s s -l silent -d 'VERSION This man page describes curl 8. 10. 1'
...
complete -c curl -l location-trusted -d '(HTTP) Instructs curl to like -L, --location follow HTTP redirects, but permi…'
