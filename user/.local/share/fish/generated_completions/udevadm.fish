...
complete -c udevadm -l subsystem-match -l subsystem-nomatch -d 'When used with --export-db, only show devices of or not of the given subsyste…'
complete -c udevadm -l attr-match -l attr-nomatch -d 'When used with --export-db, only show devices matching or not matching the gi…'
complete -c udevadm -l property-match -d 'When used with --export-db, only show devices matching the given property and…'
complete -c udevadm -l tag-match -d 'When used with --export-db, only show devices with the given tag'
complete -c udevadm -l sysname-match -d 'When used with --export-db, only show devices with the given "/sys" path'
complete -c udevadm -l name-match -d 'When used with --export-db, only show devices with the given name in "/dev"'
complete -c udevadm -l parent-match -d 'When used with --export-db, only show devices with the given parent device'
complete -c udevadm -l initialized-match -l initialized-nomatch -d 'When used with --export-db, only show devices that are initialized or not ini…'
complete -c udevadm -l json -d 'Shows output formatted as JSON'
...
complete -c udevadm -l quiet -d 'Suppress error logging in triggering events. sp Added in version 248'
...
complete -c udevadm -s s -d 'Trigger events for devices which belong to a matching subsystem'
complete -c udevadm -s S -d 'Do not trigger events for devices which belong to a matching subsystem'
complete -c udevadm -s A -d 'Do not trigger events for devices with a matching sysfs attribute'
complete -c udevadm -s g -d 'Trigger events for devices with a matching tag'
complete -c udevadm -s y -d 'Trigger events for devices for which the last component (i. e'
complete -c udevadm -s b -d 'Trigger events for all children of a given device'
...
complete -c udevadm -l no-summary -d 'Do not show summary. sp Added in version 254'
