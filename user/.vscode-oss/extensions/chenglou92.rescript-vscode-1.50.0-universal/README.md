...
See [CHANGELOG](https://github.com/rescript-lang/rescript-vscode/blob/HEAD/CHANGELOG.md)

## 👏 How to Contribute

Read our [Contributing Guide](https://github.com/rescript-lang/rescript-vscode/blob/HEAD/CONTRIBUTING.md)

## 📄 License

See the [LICENSE](https://github.com/rescript-lang/rescript-vscode/blob/HEAD/LICENSE.txt) file for details.
